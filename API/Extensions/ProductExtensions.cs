...
public static class ProductExtensions
{
    ...
    public static IQueryable<Product> Search(this IQueryable<Product> query, string? searchTerms)
    {
        if (string.IsNullOrEmpty(searchTerms)) return query;

        var lowerCaseSearchTerm = searchTerms.Trim().ToLower();
